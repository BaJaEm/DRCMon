...
public class DRCBasicAuthRestWeb extends DRCRestTemplate
{
    ...
    public DRCBasicAuthRestWeb(String _url, final String _username, final String _password)
    {
        this(_url, new HashMap<String, String>(), _username, _password);

    }

    public DRCBasicAuthRestWeb(String _url, Map<String, String> _headers, final String _username,
